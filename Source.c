...
int __stdcall WinMain(HINSTANCE Instance, HINSTANCE PreviousInstance, PSTR CommandLine, int CmdShow)
{
    ...
    if (Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\6x7Font.bmpx", &g6x7Font) != ERROR_SUCCESS)
    {
...
DWORD InitializeHero(void)
{
    ...
    gPlayer.CurrentArmor = SUITE_0;

    gPlayer.Direction = DIRECTION_DOWN; 
    
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Down_Standing.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_DOWN_0]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Down_Walk1.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_DOWN_1]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Down_Walk2.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_DOWN_2]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Left_Standing.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_LEFT_0]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Left_Walk1.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_LEFT_1]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Left_Walk2.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_LEFT_2]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Right_Standing.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_RIGHT_0]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Right_Walk1.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_RIGHT_1]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Right_Walk2.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_RIGHT_2]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Up_Standing.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_UPWARD_0]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Up_Walk1.bmpx",
        &gPlayer.Sprite[SUITE_0][FACING_UPWARD_1]);
    ...
    Error = Load32BppBitmapFromFile("C:\\Users\\User\\Desktop\\Game1\\Assets\\Hero_Suit0_Up_Walk2.bmpx", 
        &gPlayer.Sprite[SUITE_0][FACING_UPWARD_2]);
    ...
    for (int Character = 0; Character < StringLength; Character++)
    {
        ...
        switch (String[Character])
        {
            ...
            case '»':
            {
                ...
                // It is extended ASCII 0xBB, decimal 187, right double-angle quotes, which is used as an arrow to mark menu items.
            ...
            {
                // Github did not preserve this character and instead turned it into a "question mark inside of a diamond" character. 
                // It is extended ASCII 0xAB, decimal 171, left double-angle quotes, which is used as an arrow to mark menu items.
        ...
        for (int YPixel = 0; YPixel < CharHeight; YPixel++)
        {
            ...
            {
                FontSheetOffset = StartingFontSheetByte + XPixel - (GameBitmap->BitmapInfo.bmiHeader.biWidth \
                    * YPixel);

                StringBitmapOffset = (Character * CharWidth) + ((StringBitmap.BitmapInfo.bmiHeader.biWidth \
                    * StringBitmap.BitmapInfo.bmiHeader.biHeight) - \
                    StringBitmap.BitmapInfo.bmiHeader.biWidth) + XPixel - \
                    (StringBitmap.BitmapInfo.bmiHeader.biWidth) * YPixel;

                memcpy_s(&FontSheetPixel, sizeof(PIXEL32), (PIXEL32*)GameBitmap->Memory + FontSheetOffset, 
                    sizeof(PIXEL32));
